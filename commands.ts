...
export const messages = {
    ...
    SEX_M: `Ваш пол - 'Мужской', введите комманду ${commands.CHANGE_SEX}, что бы сменить пол или  ${commands.SEARCH_COMMAND} - ${commands.SEARCH_COMMAND_DESCRIPTION}`,
    SEX_W: `Ваш пол - 'Женский', введите комманду ${commands.CHANGE_SEX}, что бы сменить пол или ${commands.SEARCH_COMMAND} - ${commands.SEARCH_COMMAND_DESCRIPTION}`,
